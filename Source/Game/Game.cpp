...
namespace Chess {
	...
	Game_Base::Game_Base () :
		...
		player0(new AI(Chess::Color::white,
			               & this->board)), //holds references to pieces at index (0, 0) through (1, 15)
		player1(new AI(Chess::Color::black,
			               & this->board)) //holds references to pieces at index (6, 0) through (7, 7)
	{
		board.game = this;
