...
namespace Chess {
	...
	ImageFiles Pawn::imageFiles {/* black */ "./Assets/Bitmaps/BlackPawn.png",
								  /* white */ "./Assets/Bitmaps/WhitePawn.png"};

	ImageFiles Knight::imageFiles {/* black */ "./Assets/Bitmaps/BlackKnight.png",
									/* white */ "./Assets/Bitmaps/WhiteKnight.png"};

	ImageFiles Bishop::imageFiles {/* black */ "./Assets/Bitmaps/BlackPawn.png",
									/* white */ "./Assets/Bitmaps/WhiteBishop.png"};

	ImageFiles Rook::imageFiles {/* black */ "./Assets/Bitmaps/BlackRook.png",
								  /* white */ "./Assets/Bitmaps/WhiteRook.png"};

	ImageFiles Queen::imageFiles {/* black */ "./Assets/Bitmaps/BlackQueen.png",
								   /* white */ "./Assets/Bitmaps/WhiteQueen.png"};

	ImageFiles King::imageFiles {/* black */ "./Assets/Bitmaps/BlackKing.png",
...
Piece & Piece::operator = (const Piece & rhs) {
	...
	vector <MoveIntent> Piece::getAllPossibleLegalMoves () {
		...
		for (auto & square : squares) {
			...
			legalMoves.push_back(MoveIntent(true, pc, moveDestination,
			                                this->square->getBoard()->evaluateAfterHypotheticalMove(this,
			                                                                                        moveDestination)));
		}
	...
	tree <MoveIntent> Piece::getPossibleLegalMovesTree () {
		...
		for (auto i = 0; i < squares.size(); i++) {
			...
			currentTreePos = legalMoves.insert(currentTreePos, MoveIntent(true, borp, moveDestination,
			                                                              this->square->getBoard()->evaluateAfterHypotheticalMove(
	...
	vector <vec2 <int>> Pawn::getAllPossibleLegalMovePositions () const {
		...
		vector <const Square *> emptySquares = square->getBoard()->getSpecifiedSquares(* getPosition(),
		                                                                               ...
		                                                                               SafeBoolean::f,
		                                                                               Color::black); //last argument should be ignored

		vector <const Square *> captureSquares;
		vector <const Square *> captureSquares_temporary = square->getBoard()->getSpecifiedSquares(* getPosition(), {getLegalCaptureDirections()},
		                                                                                           1, SafeBoolean::t, getOpposite(getColor()));
	...
	vector <vec2 <int>> Knight::getAllPossibleLegalMovePositions () const {
		...
		auto squares = square->getBoard()->getSpecifiedSquares(* getPosition(),
		                                                       this->getLegalMovementDirections(), 1, SafeBoolean::t,
		                                                       getOpposite(getColor()));
	...
	const vector <Direction> Bishop::getLegalMovementDirections () const {
		return vector <Direction> {Directions::upLeft, Directions::upRight, Directions::downLeft,
	...
	const vector <Direction> Queen::getLegalMovementDirections () const {
		return vector <Direction> {Directions::up, Directions::down, Directions::left, Directions::right,
		                           Directions::upLeft, Directions::upRight, Directions::downLeft,
		                           Directions::downRight};
	}
